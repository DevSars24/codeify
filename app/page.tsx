    ...
    <div className="min-h-screen bg-black text-white overflow-hidden">
      ...
      <section className="max-w-6xl mx-auto px-6 py-32 grid md:grid-cols-2 gap-24 items-center">
        ...
        <div>
          ...
          <p ref={descRef} className="text-lg text-zinc-300 mb-6 leading-relaxed">
        ...
        <div ref={imageRef} className="flex justify-center perspective-[1200px]">
          ...
          >
            <Avatar className="w-full h-full">
              <AvatarImage src={photo.src} className="rounded-full backface-hidden" />
              <AvatarFallback className="backface-hidden">SR</AvatarFallback>
            </Avatar>
          </div>
      ...
      >
        ...
        <p className="text-zinc-300 mb-4 leading-relaxed">
          I built this project to help beginners who struggle in their first year —
          not due to lack of intelligence, but lack of guidance.
        </p>

        <p className="text-zinc-400 mb-4 leading-relaxed">
          Coding should be accessible anywhere, even without a powerful laptop.
        </p>

        <p className="text-zinc-400 leading-relaxed">
          Code Saarthi enables hands-on learning using a Monaco Editor —
          detect bugs, understand logic, and strengthen fundamentals on any device.
        </p>
      </section>
